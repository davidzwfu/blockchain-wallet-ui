...
export default function StartExisting() {
  ...
  function handleMnemonic(event: React.FormEvent) {
    ...
    try {
      ...
      setError('Invalid secret phrase entered.')
    }
  }
      ...
      <div className="container1" key={1}>
        <div className="container1__body">
          <div className="container1__header">
            ...
            <h1 className="container1__title">Import wallet</h1>
      ...
      <div className="container1" key={3}>
        <div className="container1__body">
          <div className="container1__header">
            ...
            <h1 className="container1__title">Wallet imported</h1>
            <p className="container1__subtitle">Your wallet has been successfully imported. Click below to start using it.</p>
          </div>
        </div>
        <div className="container1__footer">
