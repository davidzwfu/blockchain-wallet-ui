...
export default function ChangePassword() {
  const [encrypted, setEncrypted] = useAtom(encryptedAtom)
  ...
  function setNewPassword(event: React.FormEvent) {
    event.preventDefault()
    if (pincode.length < 6) return
      ...
      <div className="container1" key={1}>
        <div className="container1__body">
          <div className="container1__header">
            ...
            <p className="container1__subtitle">Please enter your current password.</p>
          </div>
          <PincodeForm 
            pincode={pincode}
