...
export default function Nav() {
  ...
  return (
    <nav className="nav">
      ...
      <div className="nav-btn" ref={dropdownRef}>
        <button type="button" className="nav-btn__content" onClick={() => setIsDropdownOpen(!isDropdownOpen)}>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            <path d="M3 12H15M3 6H21M3 18H21" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        </button>
        {isDropdownOpen &&
          <div className="dropdown-menu dropdown-menu--long">
